        ...
        >
          ...
          >
            <div className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
              ...
              <button
                onClick={onclose}
                className="absolute top-5 right-5 z-20 text-zinc-400 hover:text-white transition text-xl"
              >
                ✕
              </button>
              ...
              <div className="relative px-8 pt-14 pb-10 text-center">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.96 }}
                  className="group relative w-full h-12 rounded-xl bg-white text-black font-semibold shadow-xl flex items-center justify-center gap-3 hover:shadow-2xl transition"
